...
type CreateTaskRequest struct {
	...
	StdinNeeded bool `protobuf:"varint,11,opt,name=stdin_needed,json=stdinNeeded,proto3" json:"stdin_needed,omitempty"`
	// Whether to stream stdout.
	// One of `stdin`, `stdout`, and `stderr` MUST be true.
	StdoutNeeded bool `protobuf:"varint,12,opt,name=stdout_needed,json=stdoutNeeded,proto3" json:"stdout_needed,omitempty"`
	// Whether to stream stderr.
	// One of `stdin`, `stdout`, and `stderr` MUST be true.
	// If `tty` is true, `stderr` MUST be false. Multiplexing is not supported
	// in this case. The output of stdout and stderr will be combined to a
	// single stream.
	StderrNeeded         bool     `protobuf:"varint,13,opt,name=stderr_needed,json=stderrNeeded,proto3" json:"stderr_needed,omitempty"`
...
type CreateTaskResponse struct {
	...
	// Fully qualified URI(without host) of the attach streaming server.
...
var fileDescriptor_310e7127b8a26f14 = []byte{
	...
	,
}
...
func (this *CreateTaskRequest) String() string {
	...
	s := strings.Join([]string{`&CreateTaskRequest{`,
		...
		`StdinNeeded:` + fmt.Sprintf("%v", this.StdinNeeded) + `,`,
		`StdoutNeeded:` + fmt.Sprintf("%v", this.StdoutNeeded) + `,`,
		`StderrNeeded:` + fmt.Sprintf("%v", this.StderrNeeded) + `,`,
...
func (m *CreateTaskRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StdinNeeded", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StdinNeeded = bool(v != 0)
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StdoutNeeded", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.StdoutNeeded = bool(v != 0)
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StderrNeeded", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
