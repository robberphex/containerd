...
type WaitResponseEx_TaskState int32

const (
	WaitResponseEx_UNIVERSAL WaitResponseEx_TaskState = 0
	// The process has exited.
	WaitResponseEx_EXITED WaitResponseEx_TaskState = 1
	// The process has been killed.
	WaitResponseEx_KILLED WaitResponseEx_TaskState = 2
	// The process has been paused.
	WaitResponseEx_PAUSED WaitResponseEx_TaskState = 3
	// The process has been resumed.
	WaitResponseEx_RESUMED WaitResponseEx_TaskState = 4
)

var WaitResponseEx_TaskState_name = map[int32]string{
	0: "UNIVERSAL",
	1: "EXITED",
	2: "KILLED",
	3: "PAUSED",
...
var WaitResponseEx_TaskState_value = map[string]int32{
	"UNIVERSAL": 0,
	"EXITED":    1,
	"KILLED":    2,
	"PAUSED":    3,
...
func (x WaitResponseEx_TaskState) String() string {
	return proto.EnumName(WaitResponseEx_TaskState_name, int32(x))
}

func (WaitResponseEx_TaskState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_310e7127b8a26f14, []int{28, 0}
}
...
func (m *WaitRequestEx) Reset()      { *m = WaitRequestEx{} }
func (*WaitRequestEx) ProtoMessage() {}
func (*WaitRequestEx) Descriptor() ([]byte, []int) {
	return fileDescriptor_310e7127b8a26f14, []int{27}
}
func (m *WaitRequestEx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WaitRequestEx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WaitRequestEx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *WaitRequestEx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WaitRequestEx.Merge(m, src)
}
func (m *WaitRequestEx) XXX_Size() int {
	return m.Size()
}
func (m *WaitRequestEx) XXX_DiscardUnknown() {
	xxx_messageInfo_WaitRequestEx.DiscardUnknown(m)
}

var xxx_messageInfo_WaitRequestEx proto.InternalMessageInfo

type WaitResponseEx struct {
	ExitStatus           uint32                   `protobuf:"varint,1,opt,name=exit_status,json=exitStatus,proto3" json:"exit_status,omitempty"`
	Stdout               string                   `protobuf:"bytes,2,opt,name=stdout,proto3" json:"stdout,omitempty"`
	Stderr               string                   `protobuf:"bytes,3,opt,name=stderr,proto3" json:"stderr,omitempty"`
	State                WaitResponseEx_TaskState `protobuf:"varint,4,opt,name=state,proto3,enum=containerd.services.tasks.v1.WaitResponseEx_TaskState" json:"state,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}

func (m *WaitResponseEx) Reset()      { *m = WaitResponseEx{} }
func (*WaitResponseEx) ProtoMessage() {}
func (*WaitResponseEx) Descriptor() ([]byte, []int) {
	return fileDescriptor_310e7127b8a26f14, []int{28}
}
func (m *WaitResponseEx) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WaitResponseEx) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WaitResponseEx.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *WaitResponseEx) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WaitResponseEx.Merge(m, src)
}
func (m *WaitResponseEx) XXX_Size() int {
	return m.Size()
}
func (m *WaitResponseEx) XXX_DiscardUnknown() {
	xxx_messageInfo_WaitResponseEx.DiscardUnknown(m)
}

var xxx_messageInfo_WaitResponseEx proto.InternalMessageInfo

func init() {
	proto.RegisterEnum("containerd.services.tasks.v1.WaitResponseEx_TaskState", WaitResponseEx_TaskState_name, WaitResponseEx_TaskState_value)
	...
	proto.RegisterType((*WaitRequestEx)(nil), "containerd.services.tasks.v1.WaitRequestEx")
	proto.RegisterType((*WaitResponseEx)(nil), "containerd.services.tasks.v1.WaitResponseEx")
}
...
var fileDescriptor_310e7127b8a26f14 = []byte{
	...
	,
}
...
type TasksClient interface {
	...
	WaitEx(ctx context.Context, opts ...grpc.CallOption) (Tasks_WaitExClient, error)
}
...
func (c *tasksClient) WaitEx(ctx context.Context, opts ...grpc.CallOption) (Tasks_WaitExClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Tasks_serviceDesc.Streams[0], "/containerd.services.tasks.v1.Tasks/WaitEx", opts...)
	if err != nil {
		return nil, err
	}
	x := &tasksWaitExClient{stream}
	return x, nil
}

type Tasks_WaitExClient interface {
	Send(*WaitRequestEx) error
	Recv() (*WaitResponseEx, error)
	grpc.ClientStream
}

type tasksWaitExClient struct {
	grpc.ClientStream
}

func (x *tasksWaitExClient) Send(m *WaitRequestEx) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tasksWaitExClient) Recv() (*WaitResponseEx, error) {
	m := new(WaitResponseEx)
...
type TasksServer interface {
	...
	WaitEx(Tasks_WaitExServer) error
}
...
func (*UnimplementedTasksServer) WaitEx(srv Tasks_WaitExServer) error {
	return status.Errorf(codes.Unimplemented, "method WaitEx not implemented")
}
...
func _Tasks_WaitEx_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(TasksServer).WaitEx(&tasksWaitExServer{stream})
}

type Tasks_WaitExServer interface {
	Send(*WaitResponseEx) error
	Recv() (*WaitRequestEx, error)
	grpc.ServerStream
}

type tasksWaitExServer struct {
	grpc.ServerStream
}

func (x *tasksWaitExServer) Send(m *WaitResponseEx) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tasksWaitExServer) Recv() (*WaitRequestEx, error) {
	m := new(WaitRequestEx)
...
func (m *WaitRequestEx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WaitRequestEx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WaitRequestEx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *WaitResponseEx) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WaitResponseEx) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WaitResponseEx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.State != 0 {
		i = encodeVarintTasks(dAtA, i, uint64(m.State))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Stderr) > 0 {
...
func (m *WaitRequestEx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WaitResponseEx) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *WaitRequestEx) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WaitRequestEx{`,
		`ContainerID:` + fmt.Sprintf("%v", this.ContainerID) + `,`,
		`ExecID:` + fmt.Sprintf("%v", this.ExecID) + `,`,
		`Stdin:` + fmt.Sprintf("%v", this.Stdin) + `,`,
		`XXX_unrecognized:` + fmt.Sprintf("%v", this.XXX_unrecognized) + `,`,
...
func (this *WaitResponseEx) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WaitResponseEx{`,
		`ExitStatus:` + fmt.Sprintf("%v", this.ExitStatus) + `,`,
		`Stdout:` + fmt.Sprintf("%v", this.Stdout) + `,`,
		`Stderr:` + fmt.Sprintf("%v", this.Stderr) + `,`,
...
func (m *WaitRequestEx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WaitRequestEx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WaitRequestEx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *WaitResponseEx) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WaitResponseEx: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WaitResponseEx: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= WaitResponseEx_TaskState(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
